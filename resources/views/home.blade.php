...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('src/src/dashboard/imgs/template/favicon.svg') }}">
                                    ...
                                    <div class="row login-register-cover pb-250">
                                        <div class="col-lg-6 col-md-4 col-sm-12 mx-auto">
                                            <div class="form-login-cover">
                                                ...
                                                <div class="img-2"><img src="src/imgs/page/login-register/img-3.svg" alt="JobBox"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
